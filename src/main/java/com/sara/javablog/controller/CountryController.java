package com.sara.javablog.controller;
import java.util.List;
import javax.servlet.http.HttpServletRequest;
import com.sara.javablog.bean.Country;
import com.sara.javablog.service.CountryService;
...
@RestControllerpublic class CountryController {
  ...
  public List<Country> getCountries() {      
    ...
    System.out.println("I am called from Controller");  
  ...
  public void deleteCountry(@PathVariable("id") int id) {   countryService.deleteCountry(id);  } }
